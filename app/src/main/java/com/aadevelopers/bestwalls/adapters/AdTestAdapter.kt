...
class AdTestAdapter(val context: Context, private val wallpaperList: MutableList<Any>) :
    RecyclerView.Adapter<AdTestAdapter.WallViewHolder>() {
...
//    private lateinit var adView: AdView
    ...
    override fun onBindViewHolder(holder: AdTestAdapter.WallViewHolder, position: Int) {
                ...
                if (wallpaperList[position] is Wallpaper) {
                    ...
                    imageView.setOnClickListener {
                        if (wallpaper.isPremium == true) {
                            ...
                            builder.setMessage("You need to watch a video to view premium Wallpapers")
                                .setCancelable(false)
                                .setPositiveButton("Watch video") { dialog, id ->
                                    val intent = Intent(context, FullWallpaperActivity::class.java)
                                            ...
                                            intent.putExtra("isPremium", wallpaper.isPremium)
